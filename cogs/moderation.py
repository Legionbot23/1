...
class Moderation(commands.Cog):
    ...
    async def warn(self, ctx, member: discord.Member, *, reason="No valid reason provided."):
        if ctx.guild.me.top_role < member.top_role:
            ...
            embed2.set_footer(icon_url= ctx.guild.icon_url_as(size= 4096, format= None, static_format= "png"), text= f"— Warning sent from: {ctx.guild}")
    ...
    async def warn_error(self, ctx, error):
        ...
        if isinstance(error, commands.MissingRequiredArgument):
            embed = discord.Embed(
                ...
                description="‣ Please put a valid parameter. Example: `!warn @user [reason]`")
    ...
    async def kick(self, ctx, member: discord.Member, *, reason="No valid reason provided."):
        if ctx.guild.me.top_role < member.top_role:
            ...
            embed2.set_footer(icon_url=ctx.guild.icon_url_as(size=4096, format=None, static_format="png"), text=f"— Kicked from: {ctx.guild}")
    ...
    async def kick_error(self, ctx, error):
        if isinstance(error, commands.BadArgument):
            ...
            embed = discord.Embed(
                color=discord.Color.from_rgb(self.color[0], self.color[1], self.color[2]),
                title="➜ Passed Invalid Argument",
                description="‣ Please put a valid parameter. Example: `!kick @user [reason]`")
    ...
    async def ban(self, ctx, member: discord.Member, *, reason="No valid reason provided."):
        if ctx.guild.me.top_role < member.top_role:
            ...
            embed2.set_footer(icon_url=ctx.guild.icon_url_as(size=4096, format=None, static_format="png"), text=f"— Banned from: {ctx.guild}")
    ...
    async def ban_error(self, ctx, error):
        if isinstance(error, commands.BadArgument):
            embed = discord.Embed(
                color=discord.Color.from_rgb(self.color[1], self.color[0], self.color[0]),
                title="➜ Passed Invalid Member",
            ...
            embed = discord.Embed(
                color=discord.Color.from_rgb(self.color[1], self.color[0], self.color[0]),
                title="➜ Passed Invalid Argument",
                description="‣ Please put a valid parameter. Example: `!ban @user [reason]`")
    ...
    async def forceban_error(self, ctx, error):
        if isinstance(error, commands.BadArgument):
            embed = discord.Embed(
                ...
                description="‣ Please put a valid ID. Example: `!forceban <ID>`")
            ...
            embed = discord.Embed(
                color=discord.Color.from_rgb(self.color[0], self.color[1], self.color[2]),
                title="➜ Passed Invalid Argument",
                description="‣ Please put a valid parameter. Example: `!forceban <ID>`")
    ...
    async def unban_error(self, ctx, error):
        if isinstance(error, commands.BadArgument):
            embed = discord.Embed(
                color=discord.Color.from_rgb(self.color[0], self.color[1], self.color[2]),
                title="➜ Passed Invalid ID",
                description="‣ Please put a valid ID. Example: `!unban <ID>`")
            ...
            embed = discord.Embed(
                color=discord.Color.from_rgb(self.color[0], self.color[1], self.color[2]),
                title="➜ Passed Invalid Argument",
                description="‣ Please put a valid parameter. Example: `!unban <ID>`")
    ...
    async def purge_error(self, ctx, error):
        if isinstance(error, commands.BadArgument):
            embed = discord.Embed(
                ...
                description="‣ Please put a valid amount of messages. Example: `!purge <number>`")
            ...
            embed = discord.Embed(
                color=discord.Color.from_rgb(self.color[0], self.color[1], self.color[2]),
                title="➜ Passed Invalid Argument",
                description="‣ Please put a valid parameter. Example: `!purge <number>`")
    ...
    async def nickname_error(self, ctx, error):
        if isinstance(error, commands.BadArgument):
            embed = discord.Embed(
                color=discord.Color.from_rgb(self.color[0], self.color[1], self.color[2]),
                title="➜ Passed Invalid Member",
                description="‣ Please mention a valid member. Example: `!nickname @user`")
            ...
            embed = discord.Embed(
                color=discord.Color.from_rgb(self.color[0], self.color[1], self.color[2]),
                title="➜ Passed Invalid Argument",
                description="‣ Please put a valid parameter. Example: `!nickname @user`")
    ...
    async def nickname_error(self, ctx, error):
        if isinstance(error, commands.BadArgument):
            ...
            embed = discord.Embed(
                color=discord.Color.from_rgb(self.color[0], self.color[1], self.color[2]),
                title="➜ Passed Invalid Argument",
                description="‣ Please put a valid parameter. Example: `!resetnick @user`")
